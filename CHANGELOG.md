...
### Changed
- Route package metadata to the exact Waitless proof page and canonical repository.
- Add direct README links to the live case study, PyPI package, and visual demo.
